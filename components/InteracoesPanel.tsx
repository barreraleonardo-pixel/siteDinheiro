...
import { MessageSquare, Plus, Calendar, Clock, CheckCircle, AlertCircle, Info } from "lucide-react"
              ...
              <Card key={interacao.id} className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      {interacao.status === "pendente" && (
                        <Button size="sm" variant="outline" onClick={() => alterarStatus(interacao.id, "concluida")}>
